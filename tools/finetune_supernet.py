...
def main():
    ...
    for i, model_meta in enumerate(model_metas):
        ...
        if model_meta['overhead']['flops'] in [1099600604160.0,1099600604160.0,1082635840512.0,1082635840512.0,1071020796928.0,1071020796928.0,1096838523904.0,1096838523904.0,1054461238272.0,1054461238272.0,1062242692096.0,1062242692096.0,1098234272768.0,1098234272768.0,1056427318272.0,1056427318272.0]:
          continue
