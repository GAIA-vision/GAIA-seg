...
from .dynamic_psp_head import DynamicPPM
...
class DynamicUPerHead(BaseDecodeHead,DynamicMixin):
    ...
    def __init__(self, pool_scales=(1, 2, 3, 6), **kwargs):
        super(DynamicUPerHead, self).__init__(
        ...
        self.fpn_bottleneck = DynamicConvModule(
